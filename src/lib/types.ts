...
export interface StudentResult {
  id?: string;
  maHS: string;        // Mã học sinh gốc (File1 sau khi đã thay = Mã HS File3)
  lopTen: string;      // Tên lớp
  hoTen: string;       // Họ tên (nếu có trong file)
  // Kết quả học tập & rèn luyện theo năm
